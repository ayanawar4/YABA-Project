...
export default function Aboutus() {
  ...
  return (
    <div className="py-10 lg:py-0 container mx-auto">
      ...
      <h2 className="text-2xl font-bold tracking-tight text-primary md:text-3xl lg:text-4xl">{title}</h2>
        ...
        <div className="flex gap-6 justify-center lg:justify-normal w-full h-full lg:w-1/2">
        <div className="space-y-2 lg:space-y-5 w-1/2">
            <Image
              src={firstFrame}
              alt="frame-1"
              className="w-full"
          ...
          <div className="lg:py-6 space-y-2 lg:space-y-5  w-1/2">
          <Image
              src={secondFrame}
              alt="frame-2"
              className="w-full"
